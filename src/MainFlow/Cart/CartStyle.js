...
export const SelectCheckView = styled.TouchableOpacity`
  ...
  border-radius: 5px;
  background: ${props => props.data ? Colors.Bardil :Colors.white };
`;
...
export const CheckoutView = styled.TouchableOpacity`
  background: ${props => props.getBGcolor === 0 ? Colors.checkoutClr : Colors.Bardil};
  height: 64px;
...
align-items: center;
`
export const ECImage = styled.Image`
height: ${Responsive.heightPercentageToDP(30)}px;
width: ${Responsive.widthPercentageToDP(40)}px;
`
export const EmptyCartTitleText = styled.Text`
font-size: 28px;
font-weight: 700;
color: ${Colors.fontclr};
margin-top: 20px;
`
export  const ECDetailsText = styled.Text`
font-size: 18px;
font-weight: 400;
color: #AAAAAA;
text-align: center;
